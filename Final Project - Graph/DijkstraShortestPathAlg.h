...
private:
	...
	map<BaseVertex*, double> m_mpStartDistanceIndex;
	map<BaseVertex*, BaseVertex*> m_mpPredecessorVertex;

	set<int> m_stDeterminedVertices;

	multiset<BaseVertex*, WeightLess<BaseVertex> > m_quCandidateVertices;
